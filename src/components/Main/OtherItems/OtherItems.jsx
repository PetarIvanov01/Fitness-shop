...
const fitnessItems = [
    {
        ...
        image:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvWFhbw1gI-rahdoBsBitRBC1VCoydZ-Ai-j6FdXQjwyqsp6ZYAZpdEqLej9a-ehLWots&usqp=CAU',
    ...
    },
    {
        ...
        image:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnGp-yAri_bSMXu09eaNKMeGKVOLUSksMskw&usqp=CAU',
        price: 652.21
    },
];
...
export default function OtherItems() {
    ...
    return (
        ...
        my-[6em] p-5 mx-2 rounded-xl opacity-95">
            ...
            {fitnessItems.map(e => <ItemCard key={e.id} {...e} active={active === e.index} />)}
